 ...
 **nonce** | Optional | a random value generated by your app that enables replay protection when present.| The purpose of validating nonce parameter to prevent id token 
to be displaced. E.g. an attacker can trick the user to visit
another website by sending a valid id token from a different request.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU3MzYzOTMwNV19
-->