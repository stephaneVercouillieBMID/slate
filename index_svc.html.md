...
During the login process, you will of course need to link the end user authenticated by BMID with the end user known at your side. To that purpose, itsme(r) Login uses pairwise user identifier, meaning each Partner will have a unique *User Code* for the same User. Doing so, nobody except BMID can link one given *User Code* of Partner to a specific User identity.  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTI1MTM2Mzk1NF19
-->