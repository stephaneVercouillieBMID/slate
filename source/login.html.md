...
**acr** | Always | Could be <i>"tag:sixdots.be,2016-06:acr_basic"</i> and <i>"tag:sixdots.be,2016-06:acr_advanced"</i> depending on the value entered in the <i>"acr_values"</i>  Authorisation Request parameter.
**amr** | Never |
**azp** | Never |
