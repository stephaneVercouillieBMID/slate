...
**state** | Strongly RECOMMENDED | An opaque value used to preserve some state object in the Authentication Request, and return it unchanged in the response. This parameter SHOULD be used for preventing cross-site request forgery (XRSF).
