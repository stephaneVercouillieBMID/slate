...
**aud** | Must be the token endpoint URL, possible token end point URLs: https://**merchant**.itsme.be/oidc/token<br>https://**e2e****merchant**.itsme.be/oidc/token<br>
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjA3MjQ1NzM4Miw5MjM2NjAwOSwxNzI2MT
