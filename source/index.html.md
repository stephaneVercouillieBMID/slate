...
The user identity data provided by **itsme(r)** are data coming from the National Registry. These datas are provided to **itsme(r)** during user enrollement either directly from a card readout or indirectly through an IDentity Registrar having a strong identity verification process (e.g. face-to-face KYC)  in-place.  
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjEyMTM4ODc1MV19
-->