...
# OIDC Approval
## Introduction
 During and OIDC Approval”, the connected user gives his consent on a particular action initiated by the SP, the content detail of this action is displayed on the mobile phone.<BR>
 The idea of the OIDC “Approval” is to follow the OIDC specification and include this new concept in the protocol.
 
 
 
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIyNjAwNzYyNCw2NzgxOTg2NjUsLTEyND
