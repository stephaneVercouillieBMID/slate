...
**client_id** | MUST be a valid partner code as provided by the BMID . This value will be unique to each partner per environment.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU3ODAwNzI1OV19
-->