...
**claims** | Optional | OPTIONAL and supported, though not recommended. Usage of claims parameter in the request object is recommended over this parameter as it will be signed in the JWT token, and the data will be encrypted
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTY2NzgyODk3OF19
-->