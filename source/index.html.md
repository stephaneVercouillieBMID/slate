...
**client_id** | MUST be a valid partner code as provided by the BMID during enrollement. This value will be unique to each partner per environment.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg2NTc2NzgzM119
-->