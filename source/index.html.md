...
Once the authentication is finished (successfully or not), itsme will open the Universal/App Link indicated in the **redirect_uri**. If this **redirec_uri** is not registered as a Universal/App Link on your side, it will be interpreted as an default mobile browser
