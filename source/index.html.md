...
**aud** | Required | Audience. Possible end-point URLs https://**merchant**.itsme.be/oidc/token

https://**e2emerchant**.itsme.be/oidc/token<br>
https://**uatmerchant**.sixdots.be/oidc/token https://server.itsme.be` TODO - is it really server.itsme.be??
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwNTM4NTczOTcsNzAzNTk0MjQwLDEzNj
