...
itsme(r) Login uses pairwise user identifier, meaning each partner will have a different User Code for the same user. Doing, nobody except BMID can link  
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExMjI0NDY2MjZdfQ==
-->