...
**client_id** | MUST be a valid client_id as provided by the itsme administrator. This value will be unique to each partner per environment.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwNDk3ODgyNzRdfQ==
-->