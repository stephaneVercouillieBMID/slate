...
>### When the end-user is redirected to itsme5 in the browser, then we specify a redirect\_uri. We have to provide BMID the redirect uri’s. Can we give additional parameters? Or does the entire redirect\_uri needs to match?”
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU1NDExODAwMSwzOTM1NDc4OSwxNDM3NT
