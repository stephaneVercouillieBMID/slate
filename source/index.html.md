...
If you trigger the itsme App from your own App, you must Universal Link associated with the iOS Service Provider App is required and must be specified to Belgian Mobile ID during the on-boarding process.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTMwMTg0ODAzMCwtNjg0MDYwNjg5LC0xOT
