...
-- | -- | --
**access_token** | Always | A token that can be sent to the UserInfo endpoint
...
**refresh_token** | Never | Won't be provided as itsme(r) only maintains short-lie
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTM1NzM1MDk5Nyw2NjcyNjY5MTNdfQ==
-->