...
**itsme(r) Login** is a service provided by [Belgian Mobile ID](https://www.belgianmobileid.be) (BMID) to allow users to login securely to application.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjY1NzIxNTU1LDY2NzI2NjkxM119
-->