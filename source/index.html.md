...
Authorization Requests submitted to `https://mobileapp.sixdots.be/mobile/authorize` are sub In case of App to App and Web mobile to App authentication, BMID implements more strict specifications on the Authorization Request as in the .
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzY0MzQ1MzI2LDE0MDk1NDUzOTcsLTEwMj
