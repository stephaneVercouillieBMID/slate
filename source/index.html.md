...
## Approval
**itsme® Approval** is a service provided by [Belgian Mobile ID](https://www.belgianmobileid.be) (BMID) to allow End-Users to consent to a. During your login flow, you will delegate the end user authentication to BMID.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQyNjIwOTEzLC0xNDUzNzQ2NTIxLDM5Mz
