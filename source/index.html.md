...
## Approval
**itsme® Approval** is a service provided by [Belgian Mobile ID](https://www.belgianmobileid.be) (BMID) to allow End-Users to give their consent to a specific action. From regulation perspective, the consent obtained from the end user through **itsme(r) Approval** has the same strength as a payment confirmation in a web banking interface using card readers.  During your login flow, you will delegate the end user authentication to BMID.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTgwNDA3ODY0LDYxNDU2ODEwMywtMTQ1Mz
