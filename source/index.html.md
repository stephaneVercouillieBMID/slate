...
### App to App
Instead of going through the BMID web page where the end user has to enter his phone number, it is possible to trigger the itsme App directly by sending the Authoria specific endpoint. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU1MzUxMTkzMSwxNDQ0NzEyNzI0LC0xNT
