...
The identity data provided by itsme(r) are data coming from the National Registry typically stored on the National eID card. 
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3MzU3MDA1OTRdfQ==
-->