...
If you trigger the itsme App from your own App, you must con Universal Link associated with the iOS Service Provider App is required and must be specified to Belgian Mobile ID during the on-boarding process.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTI3MTIxMTc3NiwtNjg0MDYwNjg5LC0xOT
