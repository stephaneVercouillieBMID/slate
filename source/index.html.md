...
## Approval
**itsme® Approval** is a service provided by [Belgian Mobile ID](https://www.belgianmobileid.be) (BMID) to allow End-Users to consent to a specific action. BMID offers two templates of ap During your login flow, you will delegate the end user authentication to BMID.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3MjYzNjgyODMsLTI0OTk1OTMwOCwtMT
Q1Mzc0NjUyMSwzOTM1NDc4OSw3MzgyNjQzNTgsOTQ3MTUyNjQ4
XX0=
-->