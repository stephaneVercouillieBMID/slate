...
itsme(r) Login uses pairwise user identifier, meaning each partner will have a different User Code for the same user. Doing, nobody except BMID can link one given user code to a specific user identity.  The user identi
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2MTAxMzk5MzddfQ==
-->