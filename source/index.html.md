...
itsme(r) Login uses pairwise user identifier, meaning each partner will have a different User Code for the same user. Doing, nobody except BMID can link one given user code to a specific user identity.  The user identity is th
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQ1ODY0NTg0MF19
-->