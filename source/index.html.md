...
--------- | ------- | -----
**scope** | REQUIRED | MUST contain at least `openid` or an HTTP ERROR not\_implemented will be returned. `offline\_access` value will yield an error. MUST also include the target service in the form `service:SERVICE_CODE`. Other recognized values are: `profile`, `email`, `phone`, `address`. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTY1NDQ1OTg0XX0=
-->