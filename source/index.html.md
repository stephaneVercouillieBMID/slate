...
- The itsme App and your App (or the mobile browser sending the Authorization Request) are on the same physical device. If
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTc3OTg3ODkzNCwtMTAzNjUwNjE4MiwtMT
