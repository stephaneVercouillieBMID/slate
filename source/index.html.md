...
You have to use your private key to firstly, sign the token, then use the Itsme encryption public key to encrypt the  token. The Itsme(r0backend will then use his own private encryption key to decode your token and, your public  
  
signing key to validate your signature.
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTkzOTQxMzgwLC03NjAxNTA1NTYsLTMxMD
