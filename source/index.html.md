...
In case the itsme App is not present on the device, the end user will be redirected to a web page, according to ehthe OpenID web page of BMID, where he will be able to enter his phone number and continue the authentication flow.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjg0NzY5NjI4LC03MDE4MDIyMzIsLTI5MT
