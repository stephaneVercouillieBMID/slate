...
**itsme(r) Login** is a service provided by [Belgian Mobile ID](https://www.belgianmobileid.be) (BMID) to allow End-Users to login securely to your application.
...
Data is currently shared opnly during Login or Approval. Offline access to User information is not available.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTk1MDUwMDU1Miw2NjcyNjY5MTNdfQ==
-->