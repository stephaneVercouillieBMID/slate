...
Once the authentication is finished (successfully or not), itsme will open the Universal/App Link indicated in the **redirect_uri**. If this **redirec_uri** is not registered as a Universal/App Link on your side, it will be opened a default mobile opened
...
**at_hash** | Never | Current version of itsme(r) Core does not produce the `at_hash` value
<!--stackedit_data:
eyJoaXN0b3J5IjpbODUxNTc1NjM5LC0xNzc3ODMyMTgxLC0zMz
