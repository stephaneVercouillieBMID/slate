 ...
 **`address`** | Address | `address`, with following subfields: `street_address` (newline separator \\n), `locality`, `postal_code`, `country`
 ...
 <aside class="notice">
You can request entire claims category by its  `scope`  value (see the above table for the scope value to claim mappings)
...
app to app / 
claims(user info)
Endpoints - Authorisation endpoint- Token endp
 
 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTE4OTU4MjYwNSwtMjI4ODQ3NDA0LC04MT
