 ...
 **prompt** | Optional | MUST be `consent` if provided.|A space-delimited list of string values that specifies whether the authorisation server prompts the user for re authentication and consent.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjY4MTUxNDU3LC0yMjg4NDc0MDQsLTgxMD
