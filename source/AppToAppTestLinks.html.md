...
<a href="https://uatmerchant.itsme.be/oidc/authorization?response_type=code&client_id=OIDC_TEST1&redirect_uri=https://core-emulators-ssl.default-clu01.mgmt.belgianmobileid.be/openidclient/uat_OIDC_TEST1/authz_cb&scope=openid service:OIDC_TEST1_APPROVAL profile phone email address eid&state=anystate&nonce=anonce&prompt=login consent&max_age=1&claims={"userinfo":{"name":{"essential":true}}}&request_uri=https://core-emulators-ssl.default-clu01.mgmt.belgianmobileid.be:443/openidclient/jwt/4fz6fny0y6emeond09bwqj" target="blank">UAT - OIDC V1 confirm</a>

<a href="https://idp.uat.itsme.services/v2/authorization?response_type=code&client_id=OIDC_TEST1&redirect_uri=https://core-emulators-ssl.default-clu01.mgmt.belgianmobileid.be/openidclient/uat_OIDC_TEST1_I18N/authz_cb&scope=openid service:OIDC_TEST1_APPROVAL_I18N profile phone email address eid&state=anystate&nonce=anonce&prompt=login consent&max_age=1&claims={"userinfo":{"name":{"essential":true}}}&request_uri=https://core-emulators-ssl.default-clu01.mgmt.belgianmobileid.be:443/openidclient/jwt/6s2bqgm3x65kohz2f4a83u" target="blank">UAT - OIDC V2 confirm</a>
