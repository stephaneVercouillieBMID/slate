...
The OpenID Connect Core specification defines a sets of claims that can be requested via the <i>"scope"</i> and/or <i>"claims"</i> request parameter.

<aside class="notice">Depending on the itsme® service you are implementing, different rules migh apply when requesting claims about the User and/or the Authentication event. So, if implementing
<ul>
  <li>the <b>Authentication</b> service, you MAY request claims via the <i>"scope"</i> and/or <i>"claims"</i> request parameter</li>
  <li>the <b>Identification</b> service, you MUST at least request one claim via the <i>"scope"</i> or <i>"claims"</i> request parameter</li>
  <li>the <b>Confirmation</b> service, you MUST at least specify the WYSIWYS template in the <i>"claims"</i> request parameter</li>
</ul>
</aside>

###  Claims via "scope" request parameter
...
###  Claims via "claims" request parameter
